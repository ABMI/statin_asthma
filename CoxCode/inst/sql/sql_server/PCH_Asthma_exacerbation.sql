...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (42922443,42922453,19006963,2034603,42939631,35604734,2034599,2057265,2012256,2057243,2012255,42902110)

) I
) C UNION ALL 
SELECT 29 as codeset_id, c.concept_id FROM (select distinct I.concept_id FROM
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (19016867,42948533,42934728,42970566,19019893,19007062)

) I
) C UNION ALL 
SELECT 30 as codeset_id, c.concept_id FROM (select distinct I.concept_id FROM
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1518258,42948544)
