...
OhdsiRTools::checkUsagePackage("asthma02142")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/asthma02142.pdf")
shell("R CMD Rd2pdf ./ --output=extras/asthma02142.pdf")
...
OhdsiRTools::createRenvLockFile("asthma02142")
